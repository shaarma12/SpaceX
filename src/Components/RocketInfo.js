...
const RocketInfo = () => {
    ...
    return ReactDOM.createPortal(
        ...
        <div className='flex fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50 justify-center xl:w-[71.5rem] w-[50rem] xl:h-[35rem] h-[30rem] drop-shadow-2xl bg-white p-4 rounded-2xl overflow-y-scroll'>
            <div className='flex flex-col xl:h-[35.5rem] h-[30rem] mt-10'>
