...
const Sidebar = () => {
  return (
    ...
    <div className='mt-24 text-[#656565] text-2xl ml-5'>
      <Link to="/"><p className='hover:bg-[#f5f5f5] py-2 px-3 w-36 rounded-md'>Dashboard</p></Link>
      <Link to="/rockets"><p className='hover:bg-[#f5f5f5] py-2 px-3 -mt-2 w-28 rounded-md'>Rockets</p></Link>
    </div>
    </div>
  )
}
